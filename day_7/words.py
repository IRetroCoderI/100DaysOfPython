...
def extract_first_words(word_string):
    # Split the string by newline characters
    lines = word_string.split('\n')
    
    # Extract just the first word from each line
    first_words = []
    for line in lines:
...
# Example usage:
# Assuming your string is stored in a variable called 'word_string'
word_list = extract_first_words(words_raw)

# If you want a new string with just the words (one per line):
new_word_string = '\n'.join(word_list)

# Or if you want a comma-separated list:
comma_separated_list = ', '.join(word_list)


words = comma_separated_list.split(",")
